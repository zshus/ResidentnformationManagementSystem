...
%>
<form action="doDelete.resident" method="post">
<table id="infoTable">
<tr>
<th>ID</th>
...
<tr>
<th>Tel</th>
<th><input type="text" name="s_tel" value="<%=s.getS_tel() %>" readonly="readonly"/></th>
</tr>

<tr>
<th>Grade</th>
<th><input type="text" name="s_grade" value="<%=s.getS_grade() %>" readonly="readonly"/></th>
</tr>

<tr>
<th>Class</th>
<th><input type="text" name="s_class" value="<%=s.getS_class() %>" readonly="readonly"/></th>
</tr>
